...
class VendingMachine:
    ...
    def vend(self):
        ...
        elif self.total_funds < self.price:
            return 'You must add ${0} more funds.'.format(self.price - self.total_funds)
        else:
            self.inventory -= 1
            change = self.total_funds - self.price
            self.total_funds = 0
            if change == 0:
    ...
    def add_funds(self, amount):
        if self.inventory == 0:
            ...
            return 'Current balance: ${0}'.format(self.total_funds)

    def restock(self, number):
        self.inventory += number
        return 'Current {0} stock: {1}'.format(self.goods, self.inventory)
...
class Coin:
    ...
    def worth(self):
        ...
        self.cents = Nickel.cents if isinstance(self, Nickel) else Dime.cents
        if extra > 0:
