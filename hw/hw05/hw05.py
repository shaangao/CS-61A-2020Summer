...
def merge(incr_a, incr_b):
    ...
    "*** YOUR CODE HERE ***"
    while True:
        if next_a != None and next_b != None and next_a == next_b:
            yield next_a
            next_a = next(iter_a, None)
            next_b = next(iter_b, None)
        elif (next_a != None and next_b == None) or (next_a != None and next_b != None and next_a < next_b):
            yield next_a
            next_a = next(iter_a, None)
        elif (next_b != None and next_a == None) or (next_a != None and next_b != None and next_b < next_a):
            yield next_b
            next_b = next(iter_b, None)
        else:
            break
