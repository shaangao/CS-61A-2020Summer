...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            curr0 = take_turn(num_rolls, score1, dice)
            score0 += curr0
            if feral_hogs and abs(num_rolls - prev0) == 2:
                score0 += 3
            prev0 = curr0
            ...
            curr1 = take_turn(num_rolls, score0, dice)
            score1 += curr1
            if feral_hogs and abs(num_rolls - prev1) == 2:
                score1 += 3
            prev1 = curr1
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    "*** YOUR CODE HERE ***"
    k, score = 1, 0
    predict = make_averaged(roll_dice, trials_count)
    while k <= 10:
        predicted_score = predict(k, dice)
        if predicted_score > score:
            score, num_rolls = predicted_score, k
        k += 1
    return num_rolls
    # END PROBLEM 9
...
def bacon_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    return 0 if (10 - opponent_score % 10 + opponent_score // 10 % 10) >= cutoff else num_rolls
    # END PROBLEM 10
...
def swap_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    add_score_roll0 = 10 - opponent_score % 10 + opponent_score // 10 % 10
    new_score_roll0 = score + add_score_roll0
    if is_swap(new_score_roll0, opponent_score) and new_score_roll0 < opponent_score:
        return 0
    elif add_score_roll0 >= cutoff and not (is_swap(new_score_roll0, opponent_score) and new_score_roll0 > opponent_score):
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
